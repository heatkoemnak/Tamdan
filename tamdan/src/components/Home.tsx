...
const Home: React.FC = () => {
  return (
    <motion.div
      ...
      animate="visible"
      exit="hidden"
      className="pt-24 max-w-5xl mx-auto lg:mx-10"
    >
      <div className=" ">
        <motion.div
          variants={fadeIn}
            ...
            <motion.div variants={fadeIn} className="order-2 md:order-1">
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <motion.div variants={fadeIn} className="col-span-2">
                  <div className="flex justify-between p-4 bg-slate-700/20 rounded-xl">
                    <div>
                      <div className="font-bold text-xl text-gray-50 leading-none">
                        <span>Good day,</span>
                        <br></br>
                        <div className="pt-1">
                      ...
                      <div className="mt-5">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.9 }}
                          type="button"
                          className="inline-flex items-center justify-center py-2 px-3 rounded-lg bg-yellow-300 text-gray-800 hover:text-slate-500 text-sm font-semibold transition"
                        >
                          Start tracking
                        </motion.button>
                      </div>
